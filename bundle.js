...
var classes = ((null || true) && "_f3a026ad")
var listClasses = ((null || true) && "_fbf62c13")
...
ac(bel2, ["\n        ",bel0,"\n        ",arguments[5],"\n        ",arguments[6],"\n        ",bel1,"\n      "])
      return bel2
    }(listClasses,active.map(function (t) {
            return Todo(t, dispatch)
          }),listClasses,done.map(function (t) {
            return Todo(t, dispatch)
          }),classes,active && !active.length && done && done.length ? congrats() : null,done && done.length ? doneHeading() : null))
  }
